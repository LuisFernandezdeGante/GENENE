...
-->
				...
				<link href="css/template-style1.css" rel="stylesheet"/>
						...
						<div class="row">
							<div class="tm-top-header-inner">
								<div class="tm-logo-container">
									<img src="img/logo1.png" alt="Logo" class="tm-site-logo"/>
									<h1 class="tm-site-name tm-handwriting-font">Biblioteca "Un mundo feliz"</h1>
								</div>
						...
						<div class="container">
							<div class="row margin-bottom-60">
								...
								<div class="col-lg-5 col-md-5 tm-footer-div">
									<h3 class="tm-footer-div-title">ACERCA DE NOSOSTROS</h3>
									<p class="margin-top-15">En biblioteca "Un mundo feliz" encontraras diferentes titulos de tu interes con gran variedad de generos.</p>
									<p class="margin-top-15"> Los géneros literarios son categorías para agrupar obras por estructura y tema, siendo los principales: Narrativo (relata historias: novela, cuento), Lírico (expresa emociones: poesía, oda), Dramático (representa conflictos: teatro, tragedia, comedia) y Didáctico (enseña: ensayo, fábula). </p>
								</div>
					...
					<div>
						<div class="container">
							<div class="row tm-copyright">
								<p class="col-lg-12 small copyright-text text-center">Copyright 1984 Un mundo feliz</p>
							</div>
						</div>
					</div>
				</footer>
	...
	<xsl:template name="Home">
		<section class="tm-welcome-section">
			<div class="container tm-position-relative">
				...
				<img src="img/table-set1.png" alt="Table Set" class="tm-table-set img-responsive"/>
			</div>
		</section>
			...
			<div class="container" id="main">
				...
				<section class="tm-section tm-section-margin-bottom-0 row">
					<div class="col-lg-12 tm-section-header-container">
						<h2 class="tm-section-header gold-text tm-handwriting-font">
							<img src="img/logo1.png" alt="Logo" class="tm-site-logo"/> Recomendaciones
						</h2>
				...
				<section class="tm-section">
					<div class="row">
						<div class="col-lg-12 tm-section-header-container">
							<h2 class="tm-section-header gold-text tm-handwriting-font">
								<img src="img/logo1.png" alt="Logo" class="tm-site-logo"/> Top libros
							</h2>
							<div class="tm-hr-container">
								<hr class="tm-hr"/>
							</div>
					...
					<div class="row">
						<div class="tm-daily-menu-container margin-top-60">
							<div class="col-lg-4 col-md-4">
								<img src="img/menu-board1.png" alt="Menu board" class="tm-daily-menu-img"/>
							</div>
							<div class="col-lg-8 col-md-8">
								<p>Clasicos Imprescindibles.</p>
								<ol class="margin-top-30">
									<li>Don Quijote de la Mancha (Miguel de Cervantes)</li>
									<li>Cien años de soledad (Gabriel García Márquez)</li>
									<li>1984 (George Orwell)</li>
									<li>Crimen y castigo (Fiódor Dostoievski)</li>
		...
		<section class="tm-welcome-section">
			<div class="container tm-position-relative">
				...
				<div class="row tm-welcome-content">
					<h2 class="white-text tm-handwriting-font tm-welcome-header">
						<img src="img/header-line.png" alt="Line" class="tm-header-line"/>
						Nuestros Generos<img src="img/header-line.png" alt="Line" class="tm-header-line"/>
			...
			<div class="container" id="main">
				<section class="tm-section row">
					<div class="col-lg-12 tm-section-header-container margin-bottom-30">
						<h2 class="tm-section-header gold-text tm-handwriting-font">
							<img src="img/logo1.png" alt="Logo" class="tm-site-logo"/> Nuestros Menus
						</h2>
						<div class="tm-hr-container">
							<hr class="tm-hr"/>
						</div>
					...
					<div>
						<div class="col-lg-3 col-md-3">
							<div class="tm-position-relative margin-bottom-30">
								...
								<img src="img/vertical-menu-bg1.jpg" alt="Menu bg" class="tm-side-menu-bg"/>
			<!--HASOU-->
		...
		<section class="tm-welcome-section">
			<div class="container tm-position-relative">
				...
				<div class="row tm-welcome-content">
					<h2 class="white-text tm-handwriting-font tm-welcome-header">
						<img src="img/header-line.png" alt="Line" class="tm-header-line"/>
						Reseñas<img src="img/header-line.png" alt="Line" class="tm-header-line"/>
					</h2>
					<h2 class="gold-text tm-welcome-header-2">
						<xsl:value-of select="Datos/NombreRestaurant"/>
					</h2>
					<p class="gray-text tm-welcome-description">
						...
						<div id="video">
							<video width="100%" controls="true"  poster="/multimedia/wrc2.png">
								<source src="multimedia/wrc1.mp4">
								</source>
							</video>
						</div>
					</p>
					<a href="#main" class="tm-more-button tm-more-button-welcome">Ver más</a>
				</div>
				<img src="img/table-set1.png" alt="Table Set" class="tm-table-set img-responsive"/>
			</div>
		</section>
			...
			<div class="container" id="main">
				...
				<section class="tm-section-row">
					<h2 class="col-lg-12 margin-bottom-30">
						Audio de "Me tienes en tus manos" de Jaime Sabines
					</h2>
					<div id="ContenedorAudio">
						<div id="fotoAudio" style="width:100%">
							<img src="multimedia/wrc3.jpg" width="100%">
							</img>
