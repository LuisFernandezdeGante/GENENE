...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Camiones.aspx.cs" Inherits="CamionesWeb.Camiones" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <!-- GridView de Camion -->
            <asp:GridView ID="gvCamion" runat="server" 
                          CssClass="gridview" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Matricula" HeaderText="Nombre" />
                    <asp:BoundField DataField="TipoCamion" HeaderText="Paterno" />
                    <asp:BoundField DataField="Modelo" HeaderText="Materno" />
                    <asp:BoundField DataField="Marca" HeaderText="Telefono" />
                    <asp:BoundField DataField="Capacidad" HeaderText="Capacidad (kg)"/>  <%--DataFormatString="{0:N0}--%>
                    <asp:BoundField DataField="Kilometraje" HeaderText="Licencia" /> <%--DataFormatString="{0:N2}--%>
